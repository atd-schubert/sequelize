...
class QueryInterface {
  ...
  createSchema(schema, options) {
    options = options || this.sequelize.options ||  {};
  ...
  showAllSchemas(options) {
    options = _.assign({}, options || this.sequelize.options, {
      raw: true,
  ...
  createTable(tableName, attributes, options, model) {
    ...
    options = _.clone(options || this.sequelize.options) || {};
  ...
  addIndex(tableName, attributes, options, rawTablename) {
    ...
    options = Utils.cloneDeep(options || this.sequelize.options);
  ...
  getForeignKeysForTables(tableNames, options) {
    ...
    options = _.assign({}, options || this.sequelize.options || {}, { type: QueryTypes.FOREIGNKEYS });
